...
--                                  'JAVA CLASS',
  ...
  procedure synctrl_for_jcobjs(jchemowner varchar2, dro boolean := false,
                               pub varchar2 := '') as
    v_sql varchar2(4000);
  ...
  begin
    synctrl_for_jcobjs(jchemowner, false, 'public');
  end;

  procedure drop_syns_for_jcobjs(jchemowner varchar2) as
  begin
    synctrl_for_jcobjs(jchemowner, true);
  end;

  procedure drop_public_syns_for_jcobjs(jchemowner varchar2) as
  begin
    synctrl_for_jcobjs(jchemowner, true, 'public');
  end;
